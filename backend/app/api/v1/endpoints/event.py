...
async def get_registrations_for_event(event_id: str, current_user: UserDB = Depends(get_current_user)):
    return await RegistrationService.get_registrations_for_event(event_id, current_user)
